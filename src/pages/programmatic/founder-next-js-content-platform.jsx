...
const FounderNextjsContentPlatformPage = () => {
  React.useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Founder Next.js Content Platform - 30-Day Sprint Plan | Ivan Peycheff</title>
        <meta name="description" content="Get a personalized 30-day development plan for building your Content Platform with Next.js. Perfect for Founders who want to ship fast without the guesswork." />
        <meta property="og:title" content="Founder Next.js Content Platform - 30-Day Sprint Plan | Ivan Peycheff" />
        <meta property="og:description" content="Get a personalized 30-day development plan for building your Content Platform with Next.js. Perfect for Founders who want to ship fast without the guesswork." />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Founder Next.js Content Platform - 30-Day Sprint Plan | Ivan Peycheff" />
        <meta name="twitter:description" content="Get a personalized 30-day development plan for building your Content Platform with Next.js. Perfect for Founders who want to ship fast without the guesswork." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Get a personalized 30-day development plan for building your Content Platform with Next.js. Perfect for Founders who want to ship fast without the guesswork.",
        ...
        <section className="text-center space-y-8 mb-20">
          <div className="space-y-6">
            ...
            <p className="text-[18px] leading-[28px] text-[#A5ABB3] max-w-3xl mx-auto">
              Get a personalized sprint plan built for Founders using Next.js. Turn your vision into a shippable v1 in 30 days.
            </p>
          </div>
...
export default FounderNextjsContentPlatformPage;
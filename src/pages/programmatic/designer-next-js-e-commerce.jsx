...
const DesignerNextjsE-commercePage = () => {
  React.useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Designer Next.js E-commerce - 30-Day Sprint Plan | Ivan Peycheff</title>
        <meta name="description" content="Get a personalized 30-day development plan for building your E-commerce with Next.js. Perfect for Designers who want to ship fast without the guesswork." />
        <meta property="og:title" content="Designer Next.js E-commerce - 30-Day Sprint Plan | Ivan Peycheff" />
        <meta property="og:description" content="Get a personalized 30-day development plan for building your E-commerce with Next.js. Perfect for Designers who want to ship fast without the guesswork." />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Designer Next.js E-commerce - 30-Day Sprint Plan | Ivan Peycheff" />
        <meta name="twitter:description" content="Get a personalized 30-day development plan for building your E-commerce with Next.js. Perfect for Designers who want to ship fast without the guesswork." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Get a personalized 30-day development plan for building your E-commerce with Next.js. Perfect for Designers who want to ship fast without the guesswork.",
...
export default DesignerNextjsE-commercePage;